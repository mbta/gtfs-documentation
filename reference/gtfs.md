...
rating_description | Experimental | Included (some records) | Human-readable name of this schedule rating. Typically will be "Winter", "Spring", "Summer", or "Fall". This value may be empty, as is the case for the Ferry, when the schedule rating is not expected to have regular updates.
