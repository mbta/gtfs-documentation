...
|  bikes_allowed | Optional | Included (some records) | `1` if bikes are allowed on the trip, `2` if they are not. Empty values make no claim to whether bikes are allowed.
